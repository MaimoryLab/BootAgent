...
export function SkillsPage() {
  ...
  const selectTarget = (id: string, hash: string, agent: string, checked: boolean, existing = false) => setChanges((current) => {
    ...
    const prior = next[id] ?? { id, variant_hash: hash, targets: [] };
