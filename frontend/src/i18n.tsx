...
const english = {
  ...
  "卸载并删除全部数据": "Uninstall and delete all data",
  "确认永久删除数据": "Confirm permanent data deletion",
  "全量清理将永久删除配置文件、凭据、会话和对话数据，删除后无法找回。请确认你已完成备份。": "Full cleanup permanently deletes configuration files, credentials, sessions, and conversation data. This cannot be undone. Confirm that you have made a backup.",
  "永久删除并卸载": "Permanently delete and uninstall",
  "卸载中": "Uninstalling",
  "卸载 {name}": "Uninstall {name}",
  "确定卸载「{name}」吗？只会移除 Agent 程序，配置模版、模型服务、配置文件和对话数据都会保留。": "Uninstall “{name}”? Only the agent program will be removed. Profiles, providers, configuration files, and conversation data will be preserved.",
  "已卸载 {name}，配置和对话数据已保留": "Uninstalled {name}. Configuration and conversation data were preserved.",
  "已卸载 {name}，全部数据已删除": "Uninstalled {name}. All data was deleted.",
