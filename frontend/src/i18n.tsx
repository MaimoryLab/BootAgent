...
const english = {
  ...
  "Star 支持 OneAgent": "Star OneAgent",
  "如果 OneAgent 对你有帮助，欢迎在 GitHub 点个 Star": "If OneAgent helps you, consider starring it on GitHub",
  ...
  "文件格式无效，请确认这是 OneAgent 导出的文件": "Invalid file format. Check that this file was exported by OneAgent",
