...
const english = {
  ...
  "ChatGPT Desktop 与 Codex 共用 Profile。": "ChatGPT Desktop shares profiles with Codex.",
  "为这个桌面 Agent 选择专属 Profile。": "Choose a profile dedicated to this desktop agent.",
  "创建 Profile": "Create profile",
  "选择一个 Profile": "Select a profile",
  "请先选择一个桌面 Agent": "Select a desktop agent first",
  "还没有可用的 Profile": "No usable profiles yet",
  "先创建一个包含 Codex 的 Profile。": "Create a profile that includes Codex first.",
  "先创建一个属于该桌面 Agent 的 Profile。": "Create a profile belonging to this desktop agent first.",
  "安装桌面 Agent": "Install desktop agent",
  "桌面 Agent 安装失败": "Desktop agent installation failed",
  "确认安装": "Review installation",
  "桌面 Agent 已安装并应用 Profile。": "The desktop agent was installed and its profile applied.",
  "确认安装桌面 Agent，并应用选定的 Profile。": "Install the desktop agent and apply the selected profile.",
  "安装目标": "Installation target",
  "已安装，将重新检查": "Installed; check again",
  "将重新检查": "Recheck",
  "该 Profile 会写入 Codex，共享给 ChatGPT Desktop。": "This profile is written to Codex and shared with ChatGPT Desktop.",
  "该 Profile 只属于这个桌面 Agent。": "This profile belongs only to this desktop agent.",
  "安装过程可能需要几分钟，请保持窗口打开。": "Installation may take a few minutes. Keep this window open.",
  "选择这次要安装并配置的开发工具，每次安装一个。": "Choose the development tool to install and configure. One per run.",
  "选择一个 Agent": "Select one agent",
  "请先选择一个 Profile": "Select a profile first",
  ...
  "这个 Profile 还缺少 Key 或模型": "This Profile is missing a key or a model",
  ...
  "配置模板名称": "Profile name",
  "这次安装会保存为一个配置模板，之后可以直接应用到其他 Agent。": "This run is saved as a profile you can apply to other agents later.",
  ...
  "按引导安装第一个 Agent，OneAgent 会写入模型服务配置。": "Follow the guide to install your first agent; OneAgent writes the provider configuration.",
  ...
  "走一遍安装引导，它会保存 Provider、模型和适用 Agent。": "Run the install guide; it saves the provider, model, and agents.",
  ...
  "请先补全模型和 Agent，并为 Provider 保存 Key": "Add a model and agents, and save a key for the provider",
