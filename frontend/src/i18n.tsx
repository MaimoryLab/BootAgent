...
const english = {
  ...
  "支持检测、安装与配置，但运行时无法被 OneAgent 管理": "Supports detection, installation, and configuration, but runtime is not managed by OneAgent",
  "选择 {name}": "Select {name}",
  ...
  "用户模型服务的协议兼容性由你自己保证，OneAgent 不会为它降级或改写请求": "You are responsible for custom provider protocol compatibility. OneAgent does not downgrade or rewrite requests",
