...
const english = {
  ...
  "删除 Profile“{name}”？": "Delete profile \"{name}\"?",
  "无法删除 Profile": "Could not delete profile",
  "Profile 正在被 {agents} 使用，无法删除": "Profile is used by {agents} and cannot be deleted",
  "Provider 正在被 {agents} 使用，无法删除": "Provider is used by {agents} and cannot be deleted",
