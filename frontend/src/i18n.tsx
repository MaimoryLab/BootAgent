...
const english = {
  ...
  "与 Codex 共用 ~/.codex 配置；安装和启动不会改动配置": "Shares ~/.codex with Codex; install and launch do not change configuration",
  "状态": "Status",
  "位置": "Location",
  "打开": "Open",
  "更新或重新安装": "Update or reinstall",
  "安装 ChatGPT Desktop": "Install ChatGPT Desktop",
