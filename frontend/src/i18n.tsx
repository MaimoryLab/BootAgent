...
const english = {
  ...
  "Skills": "Skills",
  "个版本": "variants",
  "暂无可导出的 Skills": "No exportable Skills",
  "第一阶段每次只能导出一个 Skill": "Phase 1 exports one Skill at a time",
  "选中的 Skill 没有可导出的版本": "The selected Skill has no exportable variant",
