...
func (s *AgentService) Uninstall(ctx context.Context, request UpdateRequest) (app.AgentUninstallResult, error) {
	...
	return s.core.UninstallAgentWithOptions(ctx, request.AgentID, app.AgentUninstallOptions{AllowCrossEnvironment: request.AllowCrossEnvironment, RemoveUserData: request.RemoveUserData, InstallationID: request.InstallationID, InstallationIDs: request.InstallationIDs}, s.onOutput)
}
...
type UpdateRequest struct {
	...
	RemoveUserData        bool     `json:"remove_user_data,omitempty"`
